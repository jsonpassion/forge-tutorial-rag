...
**선수 지식**: [10.1 유사도 검색 심화](10.1)에서 배운 top-k, similarity_score_threshold, 거리 메트릭 개념
**학습 목표**:
...
앞서 [10.1 유사도 검색 심화](10.1)에서 top-k와 임계값으로 검색 결과의 양을 조절하는 방법을 배웠죠. 하지만 한 가지 중요한 문제가 남아 있습니다 — **검색 결과가 너무 비슷비슷하다면 어떻게 할까요?**
